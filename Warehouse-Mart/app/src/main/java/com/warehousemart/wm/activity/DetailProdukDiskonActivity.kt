...
import kotlinx.android.synthetic.main.activity_detail_produk_diskon.*
...
class DetailProdukDiskonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_detail_produk_diskon)
    ...
    private fun getInfo() {
        ...
        tv_hargajual.text = Helper().gantiRupiah(produk.harga_jual)
        tv_hargadiskon.text = Helper().gantiRupiah(produk.harga_sdiskon)
        ...
        supportActionBar!!.title = "Produk Detail"
